      ...
      $.ajax({
        ...
        success: (projects) => {
          ...
          for (let i = 0; i < projects.length; i++) {
            projectsContainer.slick('slickAdd','<div class="project""><img class="cover-image" src="' + projects[i].image + '"/><a href="'+projects[i].url+'"><h4>' + projects[i].name + '</h4></a><p>' + projects[i].teaser + '</p></div>');
          }
